...
public class SendFinishedRide extends AsyncTask<String, Void, String> {

    private String path = ("http://139.59.90.128/notification.php");
    private INotificationListener iNotificationListener = null;
    private Context context = null;

    public SendFinishedRide(Context context, INotificationListener iNotificationListener){
    ...
    protected String doInBackground(String... params) {
        ...
        String actionType = FirebaseConstant.FINISH_RIDE_NOTIFY_CLIENT;
        String riderId = FirebaseConstant.Empty;
        String clientDeviceToken = FirebaseConstant.Empty;
        String finalCost = FirebaseConstant.Empty;
        ...
        try {
            ...
            String data = URLEncoder.encode("actionType", FirebaseConstant.UTF_8) + FirebaseConstant.EQUAL + URLEncoder.encode(actionType, FirebaseConstant.UTF_8) + FirebaseConstant.AMPERSAND +
                    ...
                    URLEncoder.encode("finalCost", FirebaseConstant.UTF_8) + FirebaseConstant.EQUAL + URLEncoder.encode(finalCost, FirebaseConstant.UTF_8) + FirebaseConstant.AMPERSAND;
    ...
    protected void onPostExecute(String result) {
        ...
        iNotificationListener.OnNotificationResponse(true, Integer.parseInt(FirebaseConstant.FINISH_RIDE_NOTIFY_CLIENT));
    }
}
