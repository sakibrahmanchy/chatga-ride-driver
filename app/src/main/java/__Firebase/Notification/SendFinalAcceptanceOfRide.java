...
public class SendFinalAcceptanceOfRide extends AsyncTask<String, Void, String> {

    private String path = ("http://139.59.90.128/notification.php");
    private INotificationListener iNotificationListener = null;
    private Context context = null;

    public SendFinalAcceptanceOfRide(Context context, INotificationListener iNotificationListener){
    ...
    protected String doInBackground(String... params) {
        ...
        String actionType = FirebaseConstant.FINAL_ACCEPTANCE_NOTIFY_CLIENT;
    ...
    protected void onPostExecute(String result) {
        ...
        iNotificationListener.OnNotificationResponse(true, Integer.parseInt(FirebaseConstant.FINAL_ACCEPTANCE_NOTIFY_CLIENT));
    }
}
